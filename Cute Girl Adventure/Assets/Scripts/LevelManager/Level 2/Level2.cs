...
public class Level2 : MonoBehaviour
{
    ...
    {
        if (girlTrigger.questionSee && answerValue == 9)
        {
        ...
        else if (girlTrigger.questionSee && answerValue != 0 && answerValue != 9)
        {
    ...
    {
        if (girlTrigger.finalQuestionSee && answerValue == 1)
        {
        ...
        else if (girlTrigger.finalQuestionSee && answerValue != 1 && answerValue != 0)
        {
            StartCoroutine(WrongAnswer());
        }
    }
